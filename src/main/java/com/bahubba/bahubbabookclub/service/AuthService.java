...
public interface AuthService {
     ...
     * @throws ReaderNotFoundException The reader's info wasn't persisted to the DB for creating the
     *     auth tokens
     */
     ...
     * @throws ReaderNotFoundException The reader was not found in the DB to delete existing refresh
     *     tokens
     */
