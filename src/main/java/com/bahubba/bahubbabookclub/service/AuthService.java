...
public interface AuthService {
     ...
     * @throws ReaderNotFoundException The reader's info wasn't persisted to the DB for creating the auth tokens
     */
    AuthDTO register(NewReader newReader) throws ReaderNotFoundException;
     ...
     * @throws ReaderNotFoundException The reader was not found in the DB to delete existing refresh tokens
     */
    AuthDTO authenticate(@NotNull AuthRequest req) throws AuthenticationException, ReaderNotFoundException;
