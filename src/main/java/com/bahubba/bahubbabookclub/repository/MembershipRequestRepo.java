...
public interface MembershipRequestRepo extends JpaRepository<MembershipRequest, UUID> {
    ...
    Integer reviewMembershipRequest(final UUID id, final RequestStatus status, final BookClubRole role, final String reviewMessage, final LocalDateTime reviewed);
}
